...
class cosmology:
    ...
    def __init__(self, redshift, H0=70.4, WM=0.2726, WV=0.7274):
        ...
        self.lum_dist       = cosmocalc(self.redshift, H0=self.H0, WM=self.WM, WV=self.WV)['DL_Mpc']          ## luminosity dist in mp
        self.ang_diam_dist  = cosmocalc(self.redshift, H0=self.H0, WM=self.WM, WV=self.WV)['DA_Mpc']          ##
        self.kpc_per_arcsec = cosmocalc(self.redshift, H0=self.H0, WM=self.WM, WV=self.WV)['PS_kpc']
