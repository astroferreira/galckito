'''
    ...
    Constants that are useful to deal with Illustris data

'''

# Dict with the filters available in Illustris mocks
...
ILLUSTRIS_URL = 'http://www.illustris-project.org/api/'
ILL_HEADERS = {"api-key": "cf2d032ff45a8da4342f0b04b11f9e16"}
SUBHALO_URL = ILLUSTRIS_URL + "Illustris-1/snapshots/{}/subhalos/{}"
